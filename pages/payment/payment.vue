			...
			<radio-group name="payWay">
				<label for="">
					<view class="pay-item">
						...
						<label class="radio" >
							<radio value="" color='#FF3333' checked="true"/><text></text>
						</label>
					</view>
				</label>
				<label for="">
...
<script>
	...
	import {parseTime} from '@/common/api/tools.js'
		...
		methods: {
			...
			goPayment(){
				$http.request({
					...
					uni.navigateTo({
						url:"../payment-success/payment-success"+"?totalAmount="+res.totalAmount+"&orderId="+res.orderId,
					})
				})
