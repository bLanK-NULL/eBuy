...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap() {
			...
			let oldDefaultId = (this.$store.getters.defaultPath && this.$store.getters.defaultPath.id) || "0"
			console.log("this.$store.getters.defaultPath",this.$store.getters.defaultPath)
			if( this.isStatus ){
				$http.request({
					url:"/updateAddress",
					method:"POST",
