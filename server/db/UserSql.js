...
var User = {
	...
	insertData( param ){
		...
		let avatarUrl = param.avatarUrl || "/static/img/logo.png";
		
		return 'insert into user (userName,userPwd,phone,imgUrl,nickName,token,provider,openid) values ("'+userName+'","1234567","'+userName+'","'+avatarUrl+'","'+nickName+'","'+token+'","'+param.provider+'","'+param.openid+'")';
	}
}
